...
public:
    ...
    void gameStart();			//transition from 'players added' state to 'assign reinforcement' state
    ...
    void mainGameLoop(vector<Player*> players, Map* map);
    void reinforcementPhase(vector<Player*> players, Map* map);
